...
class ASTBuilder {
 public:
  ...
  void BuildAST(treelite::Model const& model, bool thresh_as_int, bool prob_to_int);
 ...
 private:
  ...
  ASTNode* BuildASTFromTree(ASTNode* parent,
      ...
      std::int32_t target_id, std::int32_t class_id, int nid, bool thresh_as_int, bool prob_to_int, int num_trees);
